        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-16 w-full max-w-3xl rounded-2xl border border-border/60 bg-card shadow-2xl shadow-violet-500/10 ring-1 ring-foreground/5 overflow-hidden">
            ...
            <div className="p-4 md:p-8 bg-muted/20">
              <div className="grid grid-cols-3 gap-3 md:flex md:items-center md:justify-center md:gap-4">
                <div className="flex flex-col items-center gap-2 md:gap-3 rounded-xl bg-background border border-border p-3 md:p-5 shadow-sm">
                  <div className="size-9 md:size-10 rounded-xl bg-violet-100 dark:bg-violet-900/50 flex items-center justify-center">
                    <BotIcon className="size-4 md:size-5 text-violet-600 dark:text-violet-400" />
                  </div>
                  <span className="text-xs font-medium text-center leading-tight">Agente IA</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-2 md:gap-3 rounded-xl bg-background border border-border p-3 md:p-5 shadow-sm">
                  <div className="size-9 md:size-10 rounded-xl bg-violet-100 dark:bg-violet-900/50 flex items-center justify-center">
                    <ZapIcon className="size-4 md:size-5 text-violet-600 dark:text-violet-400" />
                  </div>
                  <span className="text-xs font-medium text-center leading-tight">Automatización</span>
                </div>
                <div className="hidden md:flex flex-col gap-1">
                  <div className="h-0.5 w-8 bg-violet-300 dark:bg-violet-700 rounded" />
                  <div className="h-0.5 w-8 bg-violet-200 dark:bg-violet-800 rounded" />
                ...
                <div className="flex flex-col items-center gap-2 md:gap-3 rounded-xl bg-background border border-border p-3 md:p-5 shadow-sm">
                  <div className="size-9 md:size-10 rounded-xl bg-violet-100 dark:bg-violet-900/50 flex items-center justify-center">
                    <TrendingUpIcon className="size-4 md:size-5 text-violet-600 dark:text-violet-400" />
                  </div>
                  <span className="text-xs font-medium text-center leading-tight">Resultados</span>
                </div>
              </div>
            </div>
          </div>
